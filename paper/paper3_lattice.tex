...
G7 & bond factorization $\sigma_i^{\mathrm{loc}} = \sum\sigma_p + \sum\sigma_b$ + fresh-increment positivity (Sec.~\ref{sec:factorization}) & $1.2\times 10^{-15}$ \\
\bottomrule
\end{tabular}
\end{center}
...
\cite{p1,p2}). Exact: the seven gates (machine precision), the $f=0$ baseline
